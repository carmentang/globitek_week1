...
# Database: globitek
# Generation Time: 2016-06-14 20:39:49 +0000
# ************************************************************
...
INSERT INTO `territories` (`id`, `name`, `state_id`, `salespeople_ids`, `position`)
VALUES
	(1,'Alabama',1,'[1]',1),
	(2,'Alaska',2,'[4]',1),
	(3,'Arizona',3,'[3]',1),
	(4,'Arkansas',4,'[6]',1),
	(5,'Northern California',5,'[4]',1),
	(6,'Southern California',5,'[2]',2),
	(7,'Colorado',6,'[3]',1),
	(8,'Connecticut',7,'[9]',1),
	(9,'Delaware',8,'[9]',1),
	(10,'Florida',9,'[1]',1),
	...
	(12,'Hawaii',11,'[3]',1),
	(13,'Idaho',12,'[3]',1),
	(14,'Chicago Metro',13,'[2]',1),
	(15,'Outside Chicago',13,'[5]',2),
	(16,'Indiana',14,'[7]',1),
	(17,'Iowa',15,'[5]',1),
	(18,'Kansas',16,'[8]',1),
	(19,'Kentucky',17,'[7]',1),
	...
	(21,'Maine',19,'[9]',1),
	(22,'Maryland',20,'[9]',1),
	(23,'Massachusetts',21,'[9]',1),
	(24,'Michigan',22,'[7]',1),
	(25,'Minnesota',23,'[5]',1),
	(26,'Mississippi',24,'[1]',1),
	(27,'St. Louis Area',25,'[1]',1),
	(28,'Kansas City Area',25,'[5]',2),
	(29,'Montana',26,'[3]',1),
	(30,'Nebraska',27,'[8]',1),
	(31,'Las Vegas',28,'[2]',1),
	(32,'Outside Las Vegas',28,'[3]',2),
	(33,'New Hampshire ',29,'[9]',1),
	(34,'Northern New Jersey',30,'[9]',1),
	(35,'Southern New Jersey',30,'[2]',2),
	(36,'New Mexico',31,'[3]',1),
	(37,'New York City',32,'[2, 9]',1),
	(38,'Outside New York City',32,'[9]',2),
	(39,'North Carolina',33,'[1]',1),
	(40,'North Dakota',34,'[8]',1),
	(41,'Ohio',35,'[7]',1),
	(43,'Oregon',37,'[4]',1),
	(44,'Western Pennsylvania',38,'[7]',1),
	(45,'Eastern Pennsylvania',38,'[2]',2),
	(46,'Rhode Island',39,'[9]',1),
	(47,'South Carolina',40,'[1]',1),
	(48,'South Dakota',41,'[8]',1),
	(49,'Tennessee',42,'[1]',1),
	(50,'Texas',43,'[6]',1),
	(51,'Utah',44,'[3]',1),
	(52,'Vermont',45,'[9]',1),
	(53,'Northern Virginia',46,'[2]',1),
	(54,'Southern Virginia',46,'[1]',2),
	(55,'Washington',47,'[4]',1),
	(56,'West Virginia',48,'[7]',1),
	(57,'Wisconsin',49,'[5]',1),
	(58,'Wyoming',50,'[3]',1),
	(42,'Oklahoma',36,'[6]',1),
	(59,'Ontario',51,'[3]',1),
	(60,'Quebec',52,'[1]',1),
	(61,'Nova Scotia',53,'[2]',1),
	(62,'New Brunswick',54,'[9]',1),
	(63,'Manitoba',55,'[7]',1),
	(64,'British Columbia',56,'[2]',1),
	(65,'Prince Edward Island',57,'[8]',1),
	(66,'Saskatchewan',58,'[3]',1),
	(67,'Alberta',59,'[1]',1),
	(68,'Newfoundland and Labrador',60,'[4]',1),
	(69,'Northwest Territories',61,'[6]',1),
	(70,'Yukon',62,'[5]',1),
	(71,'Nunavut',63,'[4, 7]',1);
